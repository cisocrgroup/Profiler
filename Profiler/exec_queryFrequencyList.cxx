 ...
 * Output is the FrequencyList return value of all possible interpretations of the query word.
 */
int main( int argc, char const** argv ) {
    ...
    std::string modernDict = "/mounts/data/proj/impact/lexika/staticlex_de/staticlex_de.fbdic";
    std::string patternFile = "/mounts/data/proj/impact/software/Vaam/patterns.lexgui.txt";
	...
	std::wcout << "queryFrequencyList: Caught exception: "<< exc.what() << std::endl;
	throw exc;
    }
