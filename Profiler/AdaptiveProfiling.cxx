...
////////////////////////////////////////////////////////////////////////////////
void
Profiler::calculateCandidateSet(const Token& t,
...
////////////////////////////////////////////////////////////////////////////////
void
Profiler::calculateNonAdaptiveCandidateSet(
  const Token& t,
  csl::DictSearch::CandidateSet& candidates)
{
...
////////////////////////////////////////////////////////////////////////////////
void
Profiler::calculateAdaptiveCandidateSet(
  const Token& t,
  csl::DictSearch::CandidateSet& candidates)
{
...
////////////////////////////////////////////////////////////////////////////////
void
Profiler::createCandidatesWithCorrection(
  const Token& t,
  csl::DictSearch::CandidateSet& candidates)
{
  ...
  // 	   << t.origin().metadata()["correction"] << ")\n";
  csl::AdaptiveLex::add(
    t.metadata()["correction-lc"], t.getWOCR_lc(), candidates);
  // for (const auto& cand: candidates) {
