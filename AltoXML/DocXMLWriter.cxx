...
namespace OCRCorrection {
	...
	for( Document::const_PageIterator pageIt= doc.pagesBegin(); pageIt != doc.pagesEnd(); ++pageIt ) {
	    ...
	    std::wstring wide_sourceFile;
	    csl::string2wstring( pageIt->getImageFile(), wide_imageFile );
	    csl::string2wstring( pageIt->getSourceFile(), wide_sourceFile );
	    xml_out << "<page sourceFile=\"" << wide_sourceFile << "\" imageFile=\"" << wide_imageFile << "\">" <<std::endl;
